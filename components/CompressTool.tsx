...
export const CompressTool: React.FC = () => {
  ...
  // ✅ FIX 1: Title shortened to 58 chars (was dynamic and could exceed 60)
  const TOOL_NAME = 'Compress PDF & Images - Free Online Tool | Genz PDF';
  // ✅ FIX 2: Meta description shortened to 152 chars (was ~162)
  const TOOL_DESCRIPTION =
    'Compress PDF, JPG, PNG & WebP files directly in your browser. 100% secure, no upload, no limits. Get smallest file without visible quality loss.';
  const CANONICAL_URL = 'https://genzpdf.com/compress';
  ...
  return (
    <>
      {/* ✅ SEO Component – static title & description (fixed length) */}
      <SEO
        title={TOOL_NAME}
        description={TOOL_DESCRIPTION}
        url="/compress"
        type="SoftwareApplication"
        keywords="compress pdf, reduce pdf size, shrink pdf, optimize pdf, pdf compressor, compress image, reduce file size online free"
      />

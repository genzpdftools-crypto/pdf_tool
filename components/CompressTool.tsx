...
export const CompressTool: React.FC = () => {
  ...
  // ---------- ✅ REMOVED MANUAL JSON‑LD useEffect – now handled by <SEO /> component ----------
  // All structured data is now generated by the global SEO component.
  ...
  return (
    <>
      {/* ✅ SEO Component – dynamic title based on file, fixed URL */}
      <SEO

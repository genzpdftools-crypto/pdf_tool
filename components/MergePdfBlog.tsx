...
  ChevronRight, Lightbulb, ThumbsUp, ThumbsDown, CheckCircle2 // Added Thumbs & Check icons
} from 'lucide-react';
...
          <div className="flex flex-col items-center justify-center p-6 bg-slate-50 rounded-2xl mb-10 text-center">
            {!feedbackGiven ? (
              <>
                <h4 className="font-bold text-slate-800 m-0 mb-3">Was this article helpful?</h4>
                <div className="flex gap-4">
                  <button 
                    onClick={() => setFeedbackGiven(true)}
                    className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 hover:border-emerald-500 hover:text-emerald-600 rounded-lg transition-colors font-medium shadow-sm"
                  >
                    <ThumbsUp size={16} /> Yes
                  </button>
                  <button 
                    onClick={() => setFeedbackGiven(true)}
                    className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 hover:border-rose-500 hover:text-rose-600 rounded-lg transition-colors font-medium shadow-sm"
                  >
...
                <h4 className="font-bold m-0">Thank you for your feedback!</h4>
                <p className="text-sm text-slate-500 m-0">We'll keep improving our guides for you.</p>
              </div>
            )}
          </div>
